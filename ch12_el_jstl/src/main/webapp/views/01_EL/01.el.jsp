...
<body>
	<h3>1. 기존 방식대로 출력하기</h3>   <!-- request는 객체Object -->
	...
	<p>
		EL구문을 이용하면 get???를 통해 값을 얻어올 필요 없이 
	...
	<!-- 
		EL은 공유 범위가 제일 작은 scope부터 키값을 검색
		page => request => session => application
		작은 범위 부터 찾아서 있으면 가지고 옴 application까지 찾았는데 키가 없으면 출력안됨(오류X)
	 -->
	 ...
	 applicationScope 에 담긴 값 : ${applicationScope.scope }
